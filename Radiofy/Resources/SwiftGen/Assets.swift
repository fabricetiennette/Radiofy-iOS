...
internal enum Asset {
  ...
  internal static let darkSlateColor = ColorAsset(name: "dark_slate_color")
  internal static let greenMain = ColorAsset(name: "green_main")
  internal static let navBar = ColorAsset(name: "nav_bar")
  internal static let radiofyGreen = ColorAsset(name: "radiofy_green")
