...
class L1s {
    ...
    // SignUp
    static let dataSavingError = NSLocalizedString("Error saving user data", comment: "")
    static let nameInvalid = NSLocalizedString("Name entered is not valid. 2 characters minimum & 15 Maximum.", comment: "")
    ...
    static let goodAfternoon = NSLocalizedString("Good Afternoon", comment: "")
    ...
    static let deleteLastPhoto = NSLocalizedString("Remove current photo", comment: "")
    static let changeProfilAlert = NSLocalizedString("Change profile photo", comment: "")
    ...
    static let askPassword = NSLocalizedString("askPassword", comment: "")
    static let limitReached = NSLocalizedString("limitReached", comment: "")
    static let limitMessage = NSLocalizedString("limitMessage", comment: "")
    static let goPremium = NSLocalizedString("goPremium", comment: "")
}
